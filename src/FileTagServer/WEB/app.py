...
class LocalPathConfig:
    def __init__(self, root: Optional[str], static: str = None):
...
class WebsiteApp(FastAPI):
    def __init__(self, renderer: Renderer, database: Database, webconv: WebConverter, local_pathing: LocalPathConfig, remote_pathing: RemotePathConfig, **fastapi_kwargs: Any):
