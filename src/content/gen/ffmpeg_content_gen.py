...
#             std_out, std_err = proccess.com
#     def _generate_thumbnail(self, municate()
...
#
#
# class SimpleFfmpegVideoContentGenerator(SimpleContentGenerator):
#     def __init__(self):
#         self.backing_generator = DynamicFfmpegContentGenerator()
# file: BytesIO, file_ext: str) -> Union[Tuple[bytes, str], None]:
...
#
# class SimpleFfmpegAudioContentGenerator(SimpleContentGenerator):
#     def __init__(self):
#         self.backing_generator = DynamicFfmpegContentGenerator()
#
#     def _generate_thumbnail(self, file: BytesIO, file_ext: str) -> Union[Tuple[bytes, str], None]:
#         results = self.backing_generator.generate(file, )
#         # Returns one range; the whole file, and it's extension
#         return results[0], 'webp'
#
#     def _generate_viewable(self, file: BytesIO, file_ext: str) -> Union[Tuple[bytes, str], None]:
