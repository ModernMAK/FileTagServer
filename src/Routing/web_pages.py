...
#     page_context = parse_page_info(count, page_size, display_page, get_paged_path)
#     img_context = parse_rest_file(requested, 'thumbnail')
...
# def parse_page_info(items: int, page_size: int, current_page: int, get_page_path: Callable[[int], str],
#                     range_size: int = 5):
