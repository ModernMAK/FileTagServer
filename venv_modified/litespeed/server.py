...
from litespeed.utils import HackedExceptionReporter, ExceptionReporter, json_serial, Request
...
class App:
    ...
    def _500(self, request: Request, *args, **kwargs):
        ...
        if self._admins or self.debug:
            e = HackedExceptionReporter(request, *sys.exc_info()).get_traceback_html()
